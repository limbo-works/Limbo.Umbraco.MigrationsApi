...
Via  [**NuGet**](https://www.nuget.org/packages/Limbo.Umbraco.MigrationsApi/8.0.1):

```
dotnet add package Limbo.Umbraco.MigrationsApi --version 8.0.1
```

or:

```
Install-Package Limbo.Umbraco.MigrationsApi -Version 8.0.1
```
